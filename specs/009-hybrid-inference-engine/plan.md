...
- PASS: Missing test classifier confidence fails before submission generation instead of inferring uncertainty from target-only rows; V4.1 supplies confidence through an explicit V2B probability export.
